...
<div class="card col-md-3 bg-dark text-white">
    ...
    <div class="card-body">
        <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
                <h4 class="mt-lg-2 mt-2 font-weight-medium text-white">Add New Category</h4>
            </div>
...
<div class="card text-dark bg-white">
    <div class="card-header">
        <h4 class="mb-0 text-dark">Categories</h4>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex flex-row">
                            <a href="
                            {{ route('EditCategories', ['id'=>$item->id]) }}
                            "class="mr-2">
                                <span class="btn btn-cyan btn-circle icon-pencil"></span>
                            </a>
                            <form action="{{ route('DeleteCategories', ['id'=>$item->id]) }}" method="POST">
